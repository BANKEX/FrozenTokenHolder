...
contract SimpleToken {
    ...
    function SimpleToken (string _name, string _symbol, uint8 _decimals) public {
    ...
    function demint(address _for, uint256 _amount) internal returns (bool success) {
    ...
    function mintSomeone(address _for, uint256 _amount) onlyOwner public returns (bool success) {
        return mint(_for, _amount);
    }

    function () external {
        assert(mint(msg.sender, 10**12));
    }
